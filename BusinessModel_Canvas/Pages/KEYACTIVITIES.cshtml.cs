...
{
    public class KEYACTIVITIESModel : PageModel
    {
        private readonly Canvas_Context _context;

        public KEYACTIVITIESModel(Canvas_Context context)
        {
            _context = context;
        }
        ...
        public List<Activity> GetOurProvidingActivities()
        {
            ...
            List<Activity> tab = (from act in _context.Resources
                                  ...
                                  from tb1 in table1.DefaultIfEmpty() join serv in _context.R_ProvidesServices on tb1.ServiceID equals serv.ServiceID
